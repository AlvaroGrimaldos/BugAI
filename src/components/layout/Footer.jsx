 ...
 * ───────────────────────────────────
 * Pie de página con logo, enlace a Gmail compose, links y copyright.
 *
 * El icono de correo abre Gmail en el navegador con "Para" ya rellenado,
 * sin depender de que el usuario tenga un cliente de correo instalado.
 */
...
// Abre Gmail en el navegador con el campo "Para" pre-rellenado
const GMAIL_COMPOSE = 'https://mail.google.com/mail/?view=cm&to=holabugai@gmail.com'
    ...
    <footer className="border-t border-black/5 dark:border-white/5 bg-white dark:bg-dark-card py-9 px-6">
      <div className="max-w-6xl mx-auto flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Email — abre Gmail compose con "Para" ya rellenado */}
          <a
            href={GMAIL_COMPOSE}
            target="_blank"
            rel="noopener noreferrer"
            referrerPolicy="no-referrer"
            aria-label="Enviar email a BugAI"
            className="text-zinc-400 dark:text-zinc-500 hover:text-violet-400 dark:hover:text-violet-400 transition-colors"
          >
          ...
          <a
            href="https://instagram.com/bugai.io"
            target="_blank"
            rel="noopener noreferrer"
            referrerPolicy="no-referrer"
            aria-label="Instagram"
            className="text-zinc-400 dark:text-zinc-500 hover:text-pink-500 dark:hover:text-pink-400 transition-colors"
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" strokeWidth="2"
              strokeLinecap="round" strokeLinejoin="round">
          ...
          <a
            href="https://tiktok.com/@bugai.io"
            target="_blank"
            rel="noopener noreferrer"
            referrerPolicy="no-referrer"
            aria-label="TikTok"
          ...
          <a
            href="https://linkedin.com/company/bugai"
            target="_blank"
            rel="noopener noreferrer"
            referrerPolicy="no-referrer"
            aria-label="LinkedIn"
            className="text-zinc-400 dark:text-zinc-500 hover:text-blue-500 dark:hover:text-blue-400 transition-colors"
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
