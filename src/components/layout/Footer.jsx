    ...
    <footer className="border-t border-black/5 dark:border-white/5 bg-white dark:bg-dark-card py-9 px-6">
      <div className="max-w-6xl mx-auto flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <a href="https://instagram.com/bugai.io" target="_blank" rel="noopener noreferrer" referrerpolicy="no-referrer" aria-label="Instagram" className="text-zinc-400 dark:text-zinc-500 hover:text-pink-500 dark:hover:text-pink-400 transition-colors">
          ...
          <a href="https://tiktok.com/@bugai.io" target="_blank" rel="noopener noreferrer" referrerpolicy="no-referrer" aria-label="TikTok" className="text-zinc-400 dark:text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300 transition-colors">
          ...
          <a href="https://linkedin.com/company/bugai" target="_blank" rel="noopener noreferrer" referrerpolicy="no-referrer" aria-label="LinkedIn" className="text-zinc-400 dark:text-zinc-500 hover:text-blue-500 dark:hover:text-blue-400 transition-colors">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
