...
export default function KaiChat() {
  return (
    <section
      id="kai"
      aria-label="Asistente KAI - Chat de IA"
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-12 items-center">
          ...
          {/* CHATBASE */}
          <div className="w-full h-[600px] rounded-2xl overflow-hidden border border-brand-violet/25 shadow-lg bg-white dark:bg-dark-card">
            <iframe
